...
DFU documentation: http://infocenter.nordicsemi.com/index.jsp?topic=%2Fcom.nordic.infocenter.sdk51.v9.0.0%2Findex.html
...
without use of a Bluetooth LE dongle connected to the computer. It transfers file onto the Android
...
Android 4.3+ device with nRF Toolbox (1.11.0+) or nRF Connect (previously nRF Master Control Panel) (2.1.0+) is required.
